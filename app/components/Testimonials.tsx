...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      name: 'Carlos Almeida',
      role: 'Product Manager at RocketApps',
    ...
    {
      name: 'Fernanda Lima',
      role: 'Software Engineer at Cloudify',
    ...
    },
    {
      ...
      role: 'UX Lead at DesignFlow',
      image: 'https://via.placeholder.com/64/8257e5/ffffff?text=AP',
    ...
    },
    {
      ...
      image: 'https://via.placeholder.com/64/8257e5/ffffff?text=MO',
  ...
  return (
    <section id="avaliacoes" className="py-20 scroll-mt-24 mb-20">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary flex items-center">
                      {testimonial.name}
                      <span className="material-symbols-outlined text-primary-container text-sm ml-1 align-middle">
                        link
                      </span>
                    </h4>
                    <p className="text-sm text-primary-container">{testimonial.role}</p>
                  </div>
                </div>
      ...
      <div className="flex justify-center mt-8">
        <button className="bg-primary-container text-text-primary font-bold px-6 py-2 rounded transition-colors hover:bg-inverse-primary">
          Recomendar
        </button>
      </div>
    </section>
